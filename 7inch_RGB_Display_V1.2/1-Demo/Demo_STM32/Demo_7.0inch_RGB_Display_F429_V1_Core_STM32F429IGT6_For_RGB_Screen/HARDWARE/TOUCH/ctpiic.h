...
//IO操作函数	 
#define CTP_IIC_SCL(n)  n?HAL_GPIO_WritePin(GPIOH, GPIO_PIN_4, GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOH, GPIO_PIN_4, GPIO_PIN_RESET)//PHout(4)  //SCL
#define CTP_IIC_SDA(n)  n?HAL_GPIO_WritePin(GPIOH, GPIO_PIN_5, GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOH, GPIO_PIN_5, GPIO_PIN_RESET)//PHout(5)  //SDA	 
#define CTP_READ_SDA  HAL_GPIO_ReadPin(GPIOH, GPIO_PIN_5) //PHin(5)   //输入SDA 
