...
void SDRAM_Initialization_Sequence(SDRAM_HandleTypeDef *hsdram)
{
    ...
    SDRAM_Send_Cmd(1,FMC_SDRAM_CMD_AUTOREFRESH_MODE,4,0);//设置自刷新次数 
 //   SDRAM_Send_Cmd(1,FMC_SDRAM_CMD_AUTOREFRESH_MODE,4,0);//设置自
...
void HAL_SDRAM_MspInit(SDRAM_HandleTypeDef *hsdram)
{
    ...
    HAL_GPIO_Init(GPIOH,&GPIO_Initure);     //初始化PH6,7
